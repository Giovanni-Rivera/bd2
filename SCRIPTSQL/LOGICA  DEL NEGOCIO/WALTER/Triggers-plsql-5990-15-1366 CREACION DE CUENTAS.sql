...
BEGIN
    ...
    IF(ID_USUARIO_ACTIVO>0) THEN
        ...
        SELECT TO_CHAR(U.ID_AGENCIA) INTO ID_AGENCIA_APERTURA FROM USUARIO U WHERE U.ID_USUARIO=ID_USUARIO_ACTIVO;
        ...
        SELECT TO_CHAR(TP.NOMBRE) INTO TIPO_CUENTA_FINAL FROM TIPO_CUENTA TP WHERE TP.ID_TIPO_CUENTA=TIPO_CUENTAS;
        /*ANTES DE CREAR EL NUMERO, VAMOS A CAPTURAR EL NÚMERO ALEATORIO */
        SELECT TO_CHAR(FUNCT_NUMERO_ALEATORIO) INTO NUMERO_RANDOM FROM DUAL;
