...
/* 5.- después de insertar,Actualizar o borrar los datos en la tabla cliente debemos registrarlos en bitacora cliente (la inserción)*/
CREATE OR REPLACE TRIGGER AIDU_TBL_CLIENTE
...
BEGIN
    ...
    IF EXISTE_USUARIO=1 THEN
        /*cUANDO SE ESTÉ INSERTANDO DATOS*/
        CASE  
            WHEN INSERTING THEN
