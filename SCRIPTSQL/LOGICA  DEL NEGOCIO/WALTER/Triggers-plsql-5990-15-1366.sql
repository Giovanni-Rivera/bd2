...
CREATE SEQUENCE SEQ_PLANILLA
START WITH 1
INCREMENT BY 1; 

/*TRIGGER PARA CAMPO AUTOINCREMENTABLE*/
CREATE OR REPLACE TRIGGER BI_PLANILLA 
BEFORE INSERT ON PLANILLA
FOR EACH ROW
BEGIN
SELECT SEQ_PLANILLA.NEXTVAL INTO :NEW.ID_PLANILLA FROM DUAL;
END BI_PLANILLA;
/


ALTER TABLE BOLETA ADD NO_PLANILLA NUMBER (15,0);
ALTER TABLE BOLETA ADD CONSTRAINT FK_NO_PLANILLA FOREIGN KEY (NO_PLANILLA) REFERENCES PLANILLA(ID_PLANILLA);
